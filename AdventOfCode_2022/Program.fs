...
let main argv =
    ...
    printfn "Final result Day 17 part 2: %d" resultday17Part2
    ...
    printfn "Final result Day 19 part 2: %d" resultday19Part2
    ...
    printfn "Final result Day 21 part 1: %d" resultday21Part1
