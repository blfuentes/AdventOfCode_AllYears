...
let main argv =
    ...
    printfn "Final result Day 14 part 1: %d" resultday14Part1
    let resultday14Part2 = day14_part02.execute
    printfn "Final result Day 14 part 2: %d" resultday14Part2
    printfn ""
    ...
    printfn "Final result Day 18 part 1: %.0f" resultday18Part1
    let resultday18Part2 = day18_part02.execute
    printfn "Final result Day 18 part 2: %.0f" resultday18Part2
    printfn ""
