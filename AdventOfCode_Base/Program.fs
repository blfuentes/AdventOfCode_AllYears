...
let main argv =
    ...
    printfn "Final result Day 13 part 1: %A in %s" resultday13Part1 (Utilities.ms time13_1)
    let (resultday13Part2, timer13_2) = Utilities.duration day13_part02.execute
    printfn "Final result Day 13 part 2: %d in %s" resultday13Part2 (Utilities.ms timer13_2)

    // DAY 14
    let (resultday14Part1, time14_1) = Utilities.duration day14_part01.execute
    printfn "Final result Day 14 part 1: %A in %s" resultday14Part1 (Utilities.ms time14_1)
    let (resultday14Part2, timer14_2) = Utilities.duration day14_part02.execute
    printfn "Final result Day 14 part 2: %A in %s" resultday14Part2 (Utilities.ms timer14_2)

    // DAY 15
    let (resultday15Part1, time15_1) = Utilities.duration day15_part01.execute
    printfn "Final result Day 15 part 1: %A in %s" resultday15Part1 (Utilities.ms time15_1)
    let (resultday15Part2, timer15_2) = Utilities.duration day15_part02.execute
    printfn "Final result Day 15 part 2: %A in %s" resultday15Part2 (Utilities.ms timer15_2)

    // DAY 16
    let (resultday16Part1, time16_1) = Utilities.duration day16_part01.execute
    printfn "Final result Day 16 part 1: %A in %s" resultday16Part1 (Utilities.ms time16_1)
    let (resultday16Part2, timer16_2) = Utilities.duration day16_part02.execute
    printfn "Final result Day 16 part 2: %A in %s" resultday16Part2 (Utilities.ms timer16_2)

    // DAY 17
    let (resultday17Part1, time17_1) = Utilities.duration day17_part01.execute
    printfn "Final result Day 17 part 1: %A in %s" resultday17Part1 (Utilities.ms time17_1)
    let (resultday17Part2, timer17_2) = Utilities.duration day17_part02.execute
    printfn "Final result Day 17 part 2: %d in %s" resultday17Part2 (Utilities.ms timer17_2)

    // DAY 18
    let (resultday18Part1, time18_1) = Utilities.duration day18_part01.execute
    printfn "Final result Day 18 part 1: %A in %s" resultday18Part1 (Utilities.ms time18_1)
    let (resultday18Part2, timer18_2) = Utilities.duration day18_part02.execute
    printfn "Final result Day 18 part 2: %A in %s" resultday18Part2 (Utilities.ms timer18_2)

    // DAY 19
    let (resultday19Part1, time19_1) = Utilities.duration day19_part01.execute
    printfn "Final result Day 19 part 1: %A in %s" resultday19Part1 (Utilities.ms time19_1)
    let (resultday19Part2, timer19_2) = Utilities.duration day19_part02.execute
    printfn "Final result Day 19 part 2: %d in %s" resultday19Part2 (Utilities.ms timer19_2)

    // DAY 20
    let (resultday20Part1, time20_1) = Utilities.duration day20_part01.execute
    printfn "Final result Day 20 part 1: %A in %s" resultday20Part1 (Utilities.ms time20_1)
    let (resultday20Part2, timer20_2) = Utilities.duration day20_part02.execute
    printfn "Final result Day 20 part 2: %A in %s" resultday20Part2 (Utilities.ms timer20_2)

    // DAY 21
    let (resultday21Part1, time21_1) = Utilities.duration day21_part01.execute
    printfn "Final result Day 21 part 1: %A in %s" resultday21Part1 (Utilities.ms time21_1)
    let (resultday21Part2, timer21_2) = Utilities.duration day21_part02.execute
    printfn "Final result Day 21 part 2: %d in %s" resultday21Part2 (Utilities.ms timer21_2)

    // DAY 22
    let (resultday22Part1, time22_1) = Utilities.duration day22_part01.execute
    printfn "Final result Day 22 part 1: %d in %s" resultday22Part1 (Utilities.ms time22_1)
    let (resultday22Part2, timer22_2) = Utilities.duration day22_part02.execute
    printfn "Final result Day 22 part 2: %d in %s" resultday22Part2 (Utilities.ms timer22_2)

    // DAY 23
    let (resultday23Part1, time23_1) = Utilities.duration day23_part01.execute
    printfn "Final result Day 23 part 1: %A in %s" resultday23Part1 (Utilities.ms time23_1)
    let (resultday23Part2, timer23_2) = Utilities.duration day23_part02.execute
    printfn "Final result Day 23 part 2: %A in %s" resultday23Part2 (Utilities.ms timer23_2)

    // DAY 24
    let (resultday24Part1, time24_1) = Utilities.duration day24_part01.execute
    printfn "Final result Day 24 part 1: %d in %s" resultday24Part1 (Utilities.ms time24_1)
    let (resultday24Part2, timer24_2) = Utilities.duration day24_part02.execute
    printfn "Final result Day 24 part 2: %A in %s" resultday24Part2 (Utilities.ms timer24_2)

    // DAY 25
    let (resultday25Part1, time25_1) = Utilities.duration day25_part01.execute
    printfn "Final result Day 25 part 1: %A in %s" resultday25Part1 (Utilities.ms time25_1)
