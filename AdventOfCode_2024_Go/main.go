...
import (
	...
	"github.com/blfuentes/AdventOfCode_2024_Go/day20"
)
...
func main() {
	...
	// Day 20
	timer = time.Now()
	fmt.Printf("Final result Day 20 part 1: %v", day20.Executepart1())
	fmt.Printf(" in %v\n", time.Since(timer))
	timer = time.Now()
	fmt.Printf("Final result Day 20 part 2: %d", day20.Executepart2())
	fmt.Printf(" in %v\n", time.Since(timer))
}
