...
if (Test-Path $templatePath) {
    ...
    # Replace 2016 with the provided year
    $modifiedTemplate = $modifiedTemplate -replace '2016', $Year
...
Write-Host "`nReminder: Don't forget to add 'using AdventOfCode_2016_CSharp.day$DayNumber;' to Program.cs" -ForegroundColor Yellow